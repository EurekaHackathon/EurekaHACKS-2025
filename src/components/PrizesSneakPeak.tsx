...
import Prize from "../../public/bambua1.webp";

export default function PrizesSneakPeek() {
    return (
        <div className="flex flex-col items-center text-gray-50 pt-32 text-center">
            <h1 className="text-5xl font-semibold">A sneak peek of our prizes...</h1>
            <h2 className="text-2xl font-semibold text-gray-300 pt-1">Over $11,500 in prizes to be won</h2>
