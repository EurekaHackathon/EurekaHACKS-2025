...
export default async function ApplicationPage() {
    ...
    //     level: "H",
    // });
    // const encodedUserID = encodeHexLowerCase(sha256(new TextEncoder().encode(user.id.toString()))).slice(0, 12);
    // const qrcode = encoder.encode(new Byte(encodedUserID));
    // const dataURL = qrcode.toDataURL(21, {
    //     background: [236, 234, 253],
    //     foreground: [20, 12, 51],
    //     margin: 0
    ...
    return (
        <div className="flex p-12 justify-center items-center min-h-screen">
            <ComingSoon text="You will receive a QR Code once you are accepted as a hacker."/>
            {/*<div className="flex flex-col items-center bg-gray-50 border border-gray-300 p-8 md:p-10 lg:p-12 rounded-xl">*/}
            {/*    <div>*/}
